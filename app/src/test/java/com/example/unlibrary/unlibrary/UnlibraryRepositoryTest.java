...
//        doAnswer(invocation -> {
//            FirebaseAuth.AuthStateListener listener = invocation.getArgument(0);
//            listener.onAuthStateChanged(mLibraryAuth);
//            return null;
//        }).when(mLibraryAuth).addAuthStateListener(any());
//
...
//            return null;
//        }).when(mAuth).addAuthStateListener(any());
//
//
...
//        await().atMost(SLEEP_TIME * 10, SECONDS).until(() -> book1.getId() != null);
//
...
//
//        List<Book> mockbooks = mLibaryRepository.getBooks().getValue();
//        if (books == null) {
//            fail("Books is null");
//        }
//
...
//
//        await().atMost(SLEEP_TIME, SECONDS).until(() -> book2.getId() != null);
//        await().atMost(SLEEP_TIME, SECONDS).until(() -> request2.getId() != null);
